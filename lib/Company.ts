...
export class Company extends TornAPIBase {
    ...
    async detailed(): Promise<Errorable<ICompanyDetailed>> {
        return this.apiQuery({
            route: 'company',
            selection: 'detailed',
            jsonOverride: 'company_detailed',
        });
    }

    async employees(id?: string): Promise<Errorable<ICompanyEmployee[]>> {
        return this.apiQueryToArray(
            { route: 'company', selection: 'employees', jsonOverride: 'company_employees', id: id },
            'id'
        );
    }
    ...
    async news(from?: number, to?: number): Promise<Errorable<INews[]>> {
        return this.apiQueryToArray(
            { route: 'company', selection: 'news', from: from, to: to },
            'id'
        );
    }
    ...
    async newsfull(from?: number, to?: number): Promise<Errorable<INews[]>> {
        return this.apiQueryToArray(
            { route: 'company', selection: 'newsfull', jsonOverride: 'news', from: from, to: to },
            'id'
        );
    }
    ...
    async stock(): Promise<Errorable<ICompanyStock[]>> {
        return this.apiQueryToArray(
            { route: 'company', selection: 'stock', jsonOverride: 'company_stock' },
            'name'
        );
    }
}
